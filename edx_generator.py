        ...
        for [subsection, subsection_path] in _util.getSubFolders(section_path):
            ...
            for [unit, unit_path] in _util.getSubFolders(subsection_path):
                ...
                for [filename, filepath] in _util.getFiles(unit_path):
                    ...
                    if filex == "md" and filename != "README.md":
                        unit_comps = _write_comps.writeCompsForUnit(
                            filepath, unit_filename
                        )
            ...
            _write_structure.writeXmlForSubsection(
                subsection_path, subsection_filename, units
            )
